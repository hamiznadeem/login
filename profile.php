...
<body class="bg-fb-bg text-white/90 antialiased">
    ...
    <section class="max-w-6xl mx-auto">
        <div class="relative">
            <img src="<?php echo "$row2[cover_photo]" ?>" alt="Cover" class="w-full h-100 sm:h-72 md:h-80 object-cover">
    ...
    <main class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-6 py-6">
        ...
        <aside class="md:col-span-1 space-y-6">
            ...
            <section class="bg-fb.card rounded-2xl p-5 shadow-soft">
                <h2 class="text-lg font-semibold mb-3">Intro</h2>
                ...
                <ul class="mt-4 space-y-2 text-white/70 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        ...
                        <a href="#" class="underline hover:no-underline" target="_blank" rel="noreferrer">Portfolio</a>
                    </li>
                </ul>
            </section>
        ...
        <section class="md:col-span-2 space-y-6">
            ...
            <article class="bg-fb.card rounded-2xl shadow-soft overflow-hidden">
                ...
                <img src="<?php echo "$row2[post_image]" ?>" class="w-full max-h-[550px] object-cover" alt="">
